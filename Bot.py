...
class Metin:
    ...
    def load_images(self):
        self.settings_options = load_image('bot_images\\settings_options2.png')
        self.bot_check_bar = load_image('bot_images\\bot_check_bar2.png')
        self.restart = load_image('bot_images\\restart_img2.png')
        self.cancel_metin_img = load_image('bot_images\\cancel_metin_button2.png')
        ...
        self.weather_image = load_image('bot_images\\weather2.png')
