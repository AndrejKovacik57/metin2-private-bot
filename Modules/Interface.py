...
from Utils.Utils import load_config, save_config, get_window_screenshot
import logging
...
class ApplicationWindow:
    ...
    def init_bot(self):
        ...
        self.load_cfg_local()
        self.bot_manager = BotManager(self.display_screenshot, self.cfg['metin_stones'], self.cfg['fishing'], False)
    ...
    def load_cfg_local(self):
        ...
        locations = ['hp_bar_location', 'scan_window_location', 'metin_stack_location', 'bot_check_location']
    ...
    def save_fields(self):
        ...
        # self.cfg['information_locations']['scan_window_location'] = self.text_entry_cape_key.get()
        # self.cfg['information_locations']['hp_bar_location'] = self.text_entry_cape_key.get()
        # self.cfg['information_locations']['metin_stack_location'] = self.text_entry_cape_key.get()
        # self.cfg['information_locations']['bot_check_location'] = self.text_entry_cape_key.get()
